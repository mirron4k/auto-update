...
if enable_autoupdate then
    ...
    if updater_loaded then
        ...
        if autoupdate_loaded then
            Update.json_url = "https://raw.githubusercontent.com/mirron4k/auto-update/refs/heads/main/version.json?" .. tostring(os.clock())
            Update.prefix = "[" .. string.upper(thisScript().name) .. "]: "
            Update.url = "https://github.com/mirron4k/auto-update/"
        end
    end
end
...
local LiteTools_Commands = {
    {cmd=('{ff0000}# - 1{ffffff}'), desc=u8'Игровой процесс'},
	{cmd=('DM'), desc=u8'Наказание: DM – /jail 60 минут, DM in GZ – jail 120 минут'},
	{cmd=(u8('DB, SK, TK, PG, NRP поведение/действия')), desc=u8'Наказание: jail 60 минут'},
	{cmd=('RK'), desc=u8'Наказание: jail 40 минут'},
	
	{cmd=('{ff0000}# - 2{ffffff}'), desc=u8'Махинации'},
	{cmd=(u8('Обман администрации')), desc=u8'Наказание: mute 60 минут'},
	{cmd=(u8('NRP Обман, Махинации, Продажа виртов, Продажа имущ. за реал. деньги, Продажа/Передача аккаунта')), desc=u8'iban'},
	{cmd=(u8('Багоюз')), desc=u8'Наказание: jail 30 минут - ban навсегда'},
	{cmd=(u8('Создание фейк аккаунтов')), desc=u8'Наказание: ban 30 дней'},
	{cmd=(u8('Слив любого поста')), desc=u8'Наказание: iban + banip'},
	{cmd=('{ff0000}# - 3{ffffff}'), desc=u8'Использование посторонних программ'},
	
	{cmd=(u8('TP/Airbrake/FakeAFK/SH/Inf.Ammo/MegaJump')), desc=u8'Наказание: ban 7 дней'},
	{cmd=(u8('Рванка/CarShot/Damager/FastGun/SetFireAmmo')), desc=u8'Наказание: iban'},
	{cmd=(u8('Пульсатор, B6, Клео-Сбив')), desc=u8'Наказание: 1 warn'},
	{cmd=(u8('Spread, WallHack')), desc=u8'Наказание: ban 7 дней'},
	{cmd=(u8('AIM, SAIM')), desc=u8'Наказание: ban 14 дней'},
	{cmd=(u8('Биндер - AHK на слете')), desc=u8'Наказание: ban 30 дней'},
	{cmd=(u8('Урез. текстуры')), desc=u8'Наказание: 1 warn'},
	{cmd=(u8('Admin Checker')), desc=u8'Наказание: 1 warn'},
	{cmd=(u8('Убийство в тяж. ранении')), desc=u8'Наказание: ban 3 дня'},
	{cmd=(u8('Лечение другого игрока в ранении')), desc=u8'Наказание: 1 warn'},
	{cmd=(u8('Эмулятор')), desc=u8'Наказание: 1 warn'},
	{cmd=('{ff0000}# - 4{ffffff}'), desc=u8'Правила чата'},
	{cmd=(u8('MG')), desc=u8'Наказание: mute 15 минут'},
	{cmd=(u8('Flood')), desc=u8'Наказание: mute 20 минут'},
	{cmd=(u8('Offtop в репорт')), desc=u8'Наказание: mute 15 минут'},
	{cmd=(u8('Оск.Администрации')), desc=u8'Наказание: mute 60 минут'},
	{cmd=(u8('Неув. к Администрации')), desc=u8'Наказание: mute 30 минут'},
	{cmd=(u8('Оск. Родни')), desc=u8'Наказание: ban 7 дней'},
	{cmd=(u8('Оск. Игроков')), desc=u8'Наказание: mute 60 минут'},
	{cmd=(u8('Нарушение /gov')), desc=u8'Наказание: mute 30 минут'},
	{cmd=(u8('Реклама проектов')), desc=u8'Наказание: ban 30 дней'},
	{cmd=(u8('Неад.Поведение')), desc=u8'Наказание: mute 30 минут'},
	{cmd=(u8('Нец.Лексика')), desc=u8'Наказание: mute 10 минут'},
	{cmd=(u8('Обман Игроков')), desc=u8'Наказание: mute 60 минут'},
	{cmd=(u8('Caps Lock')), desc=u8'Наказание: mute 20 минут'},
	{cmd=(u8('Оск.Проекта')), desc=u8'Наказание: ban 15 дней'},
	{cmd=(u8('Угрозы в сторону Адм.')), desc=u8'Наказание: mute 30 минут'},
	{cmd=(u8('Реклама Ютуб канала')), desc=u8'Наказание: mute 30 минут'},
	{cmd=(u8('Нарушение рекламы бизнеса')), desc=u8'Наказание: mute 30 минут'},
	{cmd=(u8('Нарушение ПРО')), desc=u8'Наказание: mute 20 минут'},
	{cmd=(u8('Нарушение ППЭ')), desc=u8'Наказание: mute 30 минут'},
	{cmd=(u8('Реклама Ютуб канала')), desc=u8'Наказание: mute 30 минут'},
	{cmd=(u8('Упом.Родни')), desc=u8'Наказание: mute 120 минут'},
	{cmd=(u8('Реклама ВК групп')), desc=u8'Наказание: ban 30 дней'},
	{cmd=(u8('Полит.Розжиг')), desc=u8'Наказание: mute 180 минут'},
	{cmd=(u8('Общ. на полит. темы')), desc=u8'Наказание: mute 120 минут'},
	{cmd=(u8('Нарушение кд рекламы биза')), desc=u8'Наказание: mute 15 минут'},
	{cmd=(u8('Розжиг меж.розни')), desc=u8'Наказание: mute 180 минут'},
	{cmd=(u8('Нарушение кд продажи/покупки')), desc=u8'Наказание: mute 15 минут'},
	{cmd=('{ff0000}# - 5{ffffff}'), desc=u8'Правила РП Процесса'},
	{cmd=(u8('NRP Ник в организации')), desc=u8'Наказание: 1 warn(если отказался)'},
	{cmd=(u8('Коп в гетто без маски')), desc=u8'Наказание: jail 60 минут'},
	{cmd=(u8('AFK При аресте/Выход из игры')), desc=u8'Наказание: 1 warn'},
	{cmd=(u8('+C, Сбив Переката, Отводы, Слайды')), desc=u8'Наказание: jail 60 минут'},
	{cmd=(u8('NRP ПД')), desc=u8'Наказание: jail 60-120 минут'},
	{cmd=(u8('NRP /tie, /gag, /bag')), desc=u8'Наказание: 1 warn'},
	{cmd=(u8('ДБ тюнингом')), desc=u8'Наказание: jail 300-600 минут'},
	{cmd=(u8('Сбив аптеки')), desc=u8'Наказание: jail 10 минут'},
	{cmd=(u8('Сбив темпа')), desc=u8'Наказание: jail 30 минут'},
	{cmd=(u8('Массовое NRP')), desc=u8'Наказание: 1 warn + jail 120 минут'},
	{cmd=(u8('Провокация')), desc=u8'Наказание: jail 10-20 минут'},
	{cmd=(u8('Стрельба с пассажирки')), desc=u8'Наказание: jail 30 минут'},
	{cmd=(u8('Помеха')), desc=u8'Наказание: jail 30 минут'},
	{cmd=(u8('Анимки на слете')), desc=u8'Наказание: jail 15 минут'},
	{cmd=(u8('ДМ, ДБ На слете')), desc=u8'Наказание: jail 120 минут'},
	{cmd=(u8('Прыжок, бег на колесико мыши')), desc=u8'Наказание: jail 30 минут'}}
...
if not doesFileExist(getWorkingDirectory() .. '\\TrisTools\\RulesAdmins.json') then 
    local List = {
        ...
        ['MUTE'] = {
            ['Флуд'] = 20,
            ['Оск.Игроков'] = 60,
            ['Оск.Администрации'] = 60,
            ['Упоминание родных'] = 120,
            ['Неад.Поведение'] = 30,
			['CapsLock'] = 20,
            ['Нец.Лексика'] = 10
        },
...
local menuButtons = {
    ...
    {name=u8('>   Нормативы'), faicons('TERMINAL'), i = 9},
...
local elements = {
    forms = {
        ...
        offmute=new.bool(ini.forms.offmute),
        offunmute=new.bool(ini.forms.offunmute),
        spawn=new.bool(ini.forms.spawn),
        offjail=new.bool(ini.forms.offjail),
        offunjail=new.bool(ini.forms.offunjail),
...
local reportButtons = {
    ...
    {name=u8('Приятной игры'), icon=faicons('GIFT'), func = function(id,pm,nick)    
        sampSendChat('/pm '..id..' "1" Уважаемый игрок, приятного времяпровождения на нашем сервере!') refresh_current_report()        end},
...
local reconButtons = {
    {name = ('ReconOFF'), func = function(id)   sampSendChat('/reoff') end},
    {name = ('GETSTATS'), func = function(id)   sampSendChat('/getstats '..id)  end},
    {name = ('WEAP'), func = function(id)   sampSendChat('/iwep '..id)  end},
    {name = ('AZ'), func = function(id) sampSendChat('/reoff') wait(1500)  az()    wait(1000)  sampSendChat('/gethere '..id)   end},
    ...
    {name = ('GOTO'), func =    function(id)    sampSendChat('/reoff') wait(1500)  sampSendChat('/goto '..id)  end},
...
function message()
    ...
    function f:info(text)
        sampAddChatMessage(string.format("[{%s}TT | Информация{FFFFFF}] " .. text, string.sub(bit.tohex(ColorAccentsAdapter(listForColorTheme.ret.accent1.color_500):as_argb()), 3, 8)), -1)
    end
    function f:error(text)
        sampAddChatMessage(string.format("[{%s}TT | Ошибка{ffffff}] " .. text, string.sub(bit.tohex(ColorAccentsAdapter(listForColorTheme.ret.accent1.color_700):as_argb()), 3, 8)), -1)
    end
    function f:warning(text, ...)
        sampAddChatMessage(string.format("[{%s}TT | Warning{ffffff}] " .. text, string.sub(bit.tohex(ColorAccentsAdapter(listForColorTheme.ret.accent1.color_800):as_argb()), 3, 8), ...), -1)
    end
    function f:alogin(text, ...)
        sampAddChatMessage(string.format("[{%s}TT | ALogin{ffffff}] " .. text, string.sub(bit.tohex(ColorAccentsAdapter(listForColorTheme.ret.accent1.color_400):as_argb()), 3, 8), ...), -1)
    end
    function f:notify(text, types, time, addType, addText)
        if notify then
            notify.newNotify(tostring('>> TrisTools <<\n'..text), time, tonumber(types))
        ...
        if title:find('%{......%}Репорт') then
            for line in text:gmatch("[^\n]+") do
                ...
                if line:find('%{......%}(.*)(%S+)%[(%d+)%]%:(.*)') then
                    local rnick, rid, rtext = line:match('%{......%}(.*)(%S+)%[(%d+)%]%: (.*)')
...
function main()
    ...
    message():info("Скрипт начнёт работу после того, как подтвердится ваше нахождение на посту администратора.")
    message():info("Если вы являетесь администратором, войдите в {ff0000}/alogin")
    
    while not ini.auth.active do wait(100) end
    ...
    sampRegisterChatCommand('arep', function() windows.reportPanel[0] = not windows.reportPanel[0] end)
...
local reportMenu = imgui.OnFrame(function() return windows.reportPanel[0] end,
    function(window)
        ...
        do
			...
			imgui.SameLine()
            if imgui.Button(u8('Загрузить прош. репорты'), imgui.ImVec2(252, 0)) then
                checkDefine()
            end
...
local mainMenu = imgui.OnFrame(function() return windows.AdminTools[0] end,
    function(this)
        ...
        if imgui.BeginChild('##RightBar', imgui.ImVec2(-1,-1), false, imgui.WindowFlags.NoScrollbar) then
            ...
            if menuItem == 9 then
                centertextsize('Нормативы выдачи наказаний', 21)
                imgui.SetCursorPosX(5)
                imgui.BeginGroup()
                imgui.PushFont(Font[19])
                    imgui.TextColoredRGB(u8('                                              {ff0000}Нормативы выдачи наказаний для администрации {ff007b}Tris RolePlay'))
                imgui.PopFont()
                imgui.Spacing()
                imgui.Spacing()
            ...
            if menuItem == 11 then
                ...
                imgui.SetCursorPosX(5)
                imgui.BeginGroup()
				 if imgui.CollapsingHeader(u8("Обновление 2.1 - Релиз")) then
                    if imgui.BeginChild("##update_2.0", imgui.ImVec2(-1, 105), true) then
                        textsize(
                            "-  Исправлен авто-репорт\n"
                            .. "- Исправлены формы\n"
                            .. "- Изменены ответы в авто-репорте\n"
							.. "- Пофикшен вылет скрипта при настройке статы админа\n"
							.. "- Добавлены нормативы сервера\n",
                            10
                        )
                        imgui.EndChild()
                    end
                ...
                if imgui.CollapsingHeader(u8("Обновление 1.2 beta")) then
                    if imgui.BeginChild("##update_1.2", imgui.ImVec2(-1, 105), true) then
                        textsize(
                            "-  Оптимизирован код\n"
    ...
    if cmd:find('/re%s+(%d+)') then
        ...
        if rID:len() > -1 and rID:len() < 4 then
            if not rInfo.update_recon then
                ...
                message():info('Вы зашли в рекон. Выйти: /reoff, чтобы включить курсор: ПКМ.')
            else
...
function sampev.onServerMessage(color, text)
    ...
    if text:find('(%w+_%w+)%[(%d+)%]:(.*)') then
        local Rnickname, Rid, RtextP = text:match('(%w+_%w+)%[(%d+)%]:(.*)')
                        ...
                        lua_thread.create(function()
                            ...
                            while lasttimes < time_out do
                                ...
                                if forma.etrue then
                                    ...
                                    wait(1500)
                                    sampSendChat('/a [Forma]: Больше не приму.')
                                    forma.etrue = false
                                    forma.active = false
                                    break
                                end
                                if forma.efalse then
                                    ...
                                    forma.efalse = false
                                    forma.active = false
                                    sampSendChat('/a [Forma]: Форма не верная, меняй.')
                                    break
                                end
    ...
    if text:find('^Для того, чтобы закончить слежку за игроком, введите: \'/reoff\'') then
        return false
    end
    ...
    if text:find(getMyNick()..'%['..getMyId()..'%] вошёл в административную панель') then
        local lvl = text:match(getMyNick()..'%['..getMyId()..'%] вошёл в административную панель')
        ini.auth.adminLVL = tonumber(lvl)
        ini.auth.active = true 
        save()
