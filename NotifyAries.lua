...
local typeStyle = {
	{ -- 1 - normal message
		...
		rightBox = imgui.ImColor(189, 0, 79):GetU32(),
		mainBox = {
			imgui.ImColor(255, 0, 106):GetU32(), -- left top
			imgui.ImColor(0, 0, 0):GetU32(), -- right top
			imgui.ImColor(255, 0, 106):GetU32(), -- left button
			imgui.ImColor(255, 0, 106):GetU32(), -- right button
		}
	},
	{ -- 2 - info message
	text = imgui.ImColor(255, 255, 255, 255):GetVec4(),
